        ...
        <main className="min-h-screen bg-black text-white">
            ...
            <section className="px-6 lg:px-24 py-10 grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[220px]">
                ...
                <div className="md:col-span-1 p-8 rounded-[3rem] bg-zinc-900 border border-zinc-800 flex flex-col justify-between">
                    ...
                    <div>
                        <h3 className="font-bold text-sm">{t('skills.mixing.title')}</h3>
                        <p className="text-xs text-zinc-500 mt-1">{t('skills.mixing.description')}</p>
                    </div>
                </div>
                ...
                <div className="md:col-span-1 p-8 rounded-[3rem] bg-zinc-900 border border-zinc-800 flex flex-col justify-between">
                    ...
                    <div>
                        <h3 className="font-bold text-sm">{t('skills.soundDesign.title')}</h3>
                        <p className="text-xs text-zinc-500 mt-1">{t('skills.soundDesign.description')}</p>
                    </div>
                </div>
                ...
                <a href="https://www.instagram.com/vilasonmusic/" target="_blank" className="md:col-span-1 p-8 rounded-[3rem] bg-pink-950/5 border border-pink-900/20 flex flex-col justify-between hover:bg-pink-950/20 transition-all">
                    ...
                    <div>
                        <h3 className="font-bold text-sm">{t('skills.instagram.title')}</h3>
                ...
                <div className="md:col-span-1 p-8 rounded-[3rem] bg-zinc-900 border border-zinc-800 flex flex-col justify-between">
                    ...
                    <div>
                        <h3 className="font-bold text-sm">{t('skills.collaboration.title')}</h3>
                        <p className="text-xs text-zinc-500 mt-1">{t('skills.collaboration.description')}</p>
                    </div>
                </div>
