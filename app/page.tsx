...
export default function Home() {
    return (
        <main className="bg-black text-white selection:bg-indigo-500/30">
            ...
            {/* 2. The Introduction*/}
            <section className="py-24 px-6 lg:px-24 border-y border-zinc-900 bg-zinc-950">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 h-screen">
                ...
                {/* Creative Side */}
                <Link href="/creative" className="group relative flex flex-col items-center justify-center border-r border-zinc-900 overflow-hidden bg-zinc-950">
                ...
                {/* Scientist Side */}
                <Link href="/scientist" className="group relative flex flex-col items-center justify-center overflow-hidden bg-zinc-950">
